...
{  
   ...
   scanf("%f",&bp_ap);
    ...
    else if (unit <= 50 && phase == 3)
        {
            charge = 3.15;
            ca_charge+= unit * charge;
            ca_charge+= 90;
        }
    else if (unit <=101 && phase == 3)
        {
            info = unit - 51;
            charge = 3.7;
            ca_charge+= info * charge + 3.15 * 50;
    ...
    else if (unit <=300 && phase == 3)
        {
            charge = 5.8;
            ca_charge+= unit * charge;
            ca_charge+= 100;
        }
    else if (unit <=350 && phase == 3)
        {
            charge = 6.6;
            ca_charge+= unit * charge;
            ca_charge+= 120;
        }
    else if (unit <=400 && phase == 3)
        {
            charge = 6.9;
            ca_charge+= unit * charge;
            ca_charge+=130;
        }
    else if (unit <=500 && phase == 3)
        {
            charge = 7.1;
            ca_charge+= unit * charge;
            ca_charge+=140;
        }
    else if (unit >=501 && phase == 3)
        {
            charge = 7.9;
            ca_charge+= unit * charge;
            ca_charge+=150;
